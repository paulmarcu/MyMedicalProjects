		...
		<tbody>
			<c:forEach items="${analysises}" var="analysis">
				<tr>
					...
					<td><a type="button"class="btn btn-primary" href="${pageContext.request.contextPath}/analysis/editAnalysis/${analysis.id}.html" >Update</a></td>
					<td><a type="button" class="btn btn-danger" href="${pageContext.request.contextPath}/analysis/analysisDelete/${analysis.id}.html">Delete</a></td>
				</tr>
			</c:forEach>
		</tbody>
	</table>
